...
describe('Bestin Dimming Test', () => {
    ...
    it('should generate multiple command packets (light + outlet)', async () => {
        ...
        await automationManager.runScript(lightCommandConfig.script, {
            type: 'command' as any,
            timestamp: Date.now(),
        ...
        await automationManager.runScript(outletCommandConfig.script, {
            type: 'command' as any,
            timestamp: Date.now(),
    ...
    it('should generate OFF command packets correctly', async () => {
        ...
        await automationManager.runScript(lightOffConfig.script, {
            type: 'command' as any,
            timestamp: Date.now(),
