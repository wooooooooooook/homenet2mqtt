...
export class LightDevice extends GenericDevice {
    ...
    public constructCommand(commandName: string, value?: any): number[] | null {
        ...
        if (commandName === 'brightness' && entityConfig.command_brightness?.data && value !== undefined) {
        ...
        if (commandName === 'color_temp' && entityConfig.command_color_temp?.data && value !== undefined) {
