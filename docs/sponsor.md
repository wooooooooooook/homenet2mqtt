...
이 프로젝트는 **오픈소스**이며, **완전 무료**로 운영됩니다.

여러분의 후원이 이 프로젝트를 지속시키는 힘이 됩니다. 개발 및 유지보수에 들어가는 시간과 노력을 응원해 주세요 🙏
...
- 이 프로젝트는 개인이 무보수로 개발·유지보수하고 있습니다.
- 새로운 제조사 지원, 버그 수정, 문서 작성 등 꾸준한 노력이 필요합니다.
- 여러분의 작은 후원이 큰 동기부여가 됩니다.

후원해 주신 모든 분들께 진심으로 감사드립니다 ❤️
